...
function display(data){ 
    data.forEach(element => {
        ...
        wish.innerHTML=`&hearts;`;
        wish.setAttribute("class","like")
        ...
        div.append(img,name,price,button,wish);
